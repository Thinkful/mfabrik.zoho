...
class Connection(object):
    ...
    def open(self):
        print >>sys.stderr, "core.py > Connection.open() no longer needed! Remove this call."

    def close(self):
        print >>sys.stderr, "core.py > Connection.close() no longer needed! Remove this call."

    def ensure_opened(self):
        print >>sys.stderr, "core.py > Connection.ensure_opened() no longer needed! Remove this call."
