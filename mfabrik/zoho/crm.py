...
SELECT_COLUMNS_CONTACTS = 'contacts(Contact Owner,First Name,Last Name,Email,Contact Type,Email Opt Out,Signed up at,Created Time,Stripe Customer ID,Thinkful login,LinkedIn,Phone,Superlocale)'
