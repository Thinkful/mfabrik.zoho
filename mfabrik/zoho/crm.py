...
SELECT_COLUMNS_POTENTIALS = 'potentials(Potential Owner,Contact Name,Signed up at,Closing Date,Course,Stage,Lead Source,Exact lead source,Payer,Discount code,Send invoice,Learning goals,Coding experience,Created Time)'
